...
alias gemalto-tool='pkcs11-tool --module /usr/lib/libgclib.so'
...
alias lsd='ls -d */'
alias lsh='ls -d .*'
alias lss='ls -sSr --ignore="*.conv.jpg" --ignore="*.gif"'
...
for host in {Ember,Wind,Frost,Dune,Armx,Shore,Home}GW; do
