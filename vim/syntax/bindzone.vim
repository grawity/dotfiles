...
syn keyword     zoneRRType      contained A AAAA AFSDB CERT CNAME DNAME DNSKEY DS HINFO IPSECKEY KEYDATA LOC MB MG MR MX MINFO NAPTR NS NSEC NSEC3 NSEC3PARAM PTR RP RRSIG SOA SPF SSHFP SRV TXT WKS nextgroup=zoneRData skipwhite
